...
void setup() {
  ...
  sd_file_name = String("measurements" + String(random(1000)) + ".txt");
  createSDFile("TEST.txt",sd_file_column_tags);
...
void logAllMeasurements(){
  ...
  String pix_log_str = String(pix_lat_str + " , " + pix_lon_str + " , " + pix_alt_str + " | Time: "  + \
  String(execution_times_global.gps_time/1e3) + "ms");

  // Prepare logs for OZONE readings
  String ozone_log_str = String("Measurement: " + String(measurements_global.ozone) + " ppm | Time: " + \
  String(execution_times_global.ozone_time/1e3) + "ms");

  // Prepare logs for MQ7 readings
  String mq7_log_str = String("Measurement: " + String(measurements_global.mq7) + " ppm | Time: " + \
  ...
  String mq135_log_str = String(mq135_ppm_str + " , " + mq135_correctedPPM_str + \
  ...
  String bmp180_log_str = String(bmp180_temp_str + " , " + bmp180_press_str + \
  " | Time: " + String(execution_times_global.bmp180_time/1e3) + "ms");
